...
class Dataset:
    ...
    def trainMerge(self, id):
        ...
        #print(locs_float.max())
        #print(locs_float.min())
        ...
        #print(instance_infos.max())
        #print(instance_infos.min())

        #print(instance_labels.max())
        #print(instance_labels.min())


        #print(instance_pointnum.max())
        #print(instance_pointnum.min())

        #print(spatial_shape.max())
        #print(spatial_shape.min())
