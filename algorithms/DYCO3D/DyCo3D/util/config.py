...
def get_parser():
    ...
    parser.add_argument('--config', type=str, default='config/dyco3d_besthp_planteye.yaml', help='path to config file')
    ...
    parser.add_argument('--resume', type=str, default="planteye_trained.pth")
