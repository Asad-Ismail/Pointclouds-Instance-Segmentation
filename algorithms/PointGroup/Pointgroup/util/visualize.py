...
if __name__ == '__main__':
    ...
    parser.add_argument('--result_root', help='path to the predicted results', default='exp/scannetv2/pointgroup/pointgroup_default_scannet/result/epoch384_nmst0.3_scoret0.09_npointt100')
    ...
    #with open("/media/asad/adas_cv_2/pointclouds/ScanNet/Tasks/Benchmark/scannetv2_test.txt","r") as f:
    #    lines=f.readlines()
    #    for i,line in enumerate(lines):
    #opt.room_name=line.strip()
    print(opt.room_name)
